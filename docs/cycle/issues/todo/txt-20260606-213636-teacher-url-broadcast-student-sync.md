...
triaged_at: 2026-06-06T21:54:35.863Z
source: triage
priority: critical
---
## Problem
...
This is a single vertical slice: the teacher-side URL-change control, the `currentUrl` write/event append, realtime propagation to student iframes, and late-joiner hydration all land together. Tests and Playwright verification are part of this cycle, not separate work.
...
- `txt-20260606-213635-activate-resource-render-embed` — requires an active resource rendered in an embed for both teacher and students before its URL can be broadcast and followed.
