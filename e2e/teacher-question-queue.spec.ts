...
test.describe('teacher question queue + mark answered', () => {
  test.skip(
    !adminAvailable(),
    'INSTANTDB_ADMIN_TOKEN (and PUBLIC_INSTANTDB_APP_ID) unset — teacher-question-queue e2e requires admin code minting + observability queries against the live app'
  )
