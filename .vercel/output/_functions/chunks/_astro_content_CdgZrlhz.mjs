...
import { c as createSvgComponent } from './runtime_alLIHrNS.mjs';
import { h as renderElement, j as removeBase, b as isRemotePath, A as AstroError, R as RenderUndefinedEntryError, u as unescapeHTML, r as renderTemplate, U as UnknownContentCollectionError, p as prependForwardSlash, k as createHeadAndContent, c as renderComponent } from './entrypoint_rCWNP7kK.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_l6QJjjE_.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_virtual_astro_get-image_DldQepOT.mjs');
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_DhgbtWWZ.mjs');
