...
import { c as createSvgComponent } from './runtime_zqcXVOv2.mjs';
import { h as renderElement, j as removeBase, b as isRemotePath, A as AstroError, R as RenderUndefinedEntryError, u as unescapeHTML, r as renderTemplate, U as UnknownContentCollectionError, p as prependForwardSlash, k as createHeadAndContent, c as renderComponent } from './entrypoint_BV0A0AU2.mjs';
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_virtual_astro_get-image_Cj4j-eQg.mjs');
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_D-Y3x1PJ.mjs');
