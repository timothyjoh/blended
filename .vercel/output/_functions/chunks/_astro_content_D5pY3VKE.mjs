...
import { c as createSvgComponent } from './runtime_DUbz-_uE.mjs';
import { h as renderElement, j as removeBase, b as isRemotePath, A as AstroError, R as RenderUndefinedEntryError, u as unescapeHTML, r as renderTemplate, U as UnknownContentCollectionError, p as prependForwardSlash, k as createHeadAndContent, d as renderComponent } from './entrypoint_OVoc7678.mjs';
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_virtual_astro_get-image_T83WRX-z.mjs');
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_CD5S9pZ4.mjs');
