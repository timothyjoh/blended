...
import 'piccolore';
import { r as renderTemplate, c as renderSlot, d as renderComponent, e as Fragment, f as renderHead, g as defineScriptVars, a as addAttribute } from './entrypoint_OVoc7678.mjs';
import { g as getEntry, r as renderEntry } from './_astro_content_D5pY3VKE.mjs';
import { r as renderScript } from './script_YI3Izztw.mjs';
/* empty css                  */
...
#${tag} </span>`)} </div> </div>`, title, description && renderTemplate`<p class="font-sans text-lg leading-relaxed"> ${description} </p>`, author, date && renderTemplate`${renderComponent($$result, "Fragment", Fragment, {}, { "default": ($$result2) => renderTemplate` <span>•</span> <time${addAttribute(date, "datetime")}> ${new Date(date).toLocaleDateString("en-US", {
    ...
    month: "long",
    day: "numeric"
  })} </time> ` })}`, renderSlot($$result, $$slots["default"]), renderScript($$result, "/mnt/c/Users/butters/wrk/blended/src/layouts/BlogLayout.astro?astro&type=script&index=0&lang.ts"));
}, "/mnt/c/Users/butters/wrk/blended/src/layouts/BlogLayout.astro", void 0);
...
}, "/mnt/c/Users/butters/wrk/blended/src/pages/blog/[slug].astro", void 0);

const $$file = "/mnt/c/Users/butters/wrk/blended/src/pages/blog/[slug].astro";
const $$url = "/blog/[slug]";
